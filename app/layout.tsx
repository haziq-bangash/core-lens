...
export const metadata: Metadata = {
  metadataBase: new URL('https://core-lens.ai'),
  title: {
    default: 'Core Lens AI - Agentic Research Platform.',
    template: '%s | Core Lens AI',
  },
  description:
    'Core Lens is a free Agentic Research Platform that finds, analyzes, and cites information from the live web. $15/month—fast answers.',
  openGraph: {
    url: 'https://core-lens.ai',
