...
`
    : ''
}I am a current student at this university and would love to access the student discount for Contract Lens Pro.
...
Best regards`;
  ...
  const handleSubmit = () => {
    ...
    const mailtoLink = `mailto:haziqbangash@contract-lens.ai?subject=${encodeURIComponent(subject)}&body=${formattedBody}`;
