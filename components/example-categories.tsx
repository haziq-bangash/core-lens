...
const categories: Category[] = [
  {
    ...
    examples: [
      { text: 'What are the key termination clauses in this contract?', group: 'web' },
      { text: 'Summarize the indemnification obligations', group: 'web' },
      { text: 'Identify any non-compete or restrictive covenants', group: 'web' },
      { text: 'What are the payment terms and conditions?', group: 'web' },
    ],
  },
  {
    id: 'risk-analysis',
    ...
    badge: 'Deep',
    examples: [
      { text: 'Identify potential risks and liabilities in this agreement', group: 'web' },
      { text: 'What clauses could be unfavorable for the vendor?', group: 'web' },
      { text: 'Are there any ambiguous terms that need clarification?', group: 'web' },
      { text: 'Compare this NDA against standard market terms', group: 'web' },
    ],
  },
  {
    id: 'legal-research',
    ...
    icon: MicroscopeIcon,
    examples: [
      { text: 'What are the latest GDPR compliance requirements for data processing agreements?', group: 'web' },
      { text: 'Recent case law on force majeure clauses', group: 'web' },
      { text: 'Best practices for SaaS service level agreements', group: 'web' },
      { text: 'Standard limitation of liability caps in enterprise contracts', group: 'web' },
    ],
  },
];
