...
export const FIRST_MESSAGE_TEMPLATES: Record<VoiceType, string> = {
  English: `Hello! I'm Contract Lens, your AI assistant. How can I assist you today?`,
  French: `Bonjour! Je suis Contract Lens, votre assistant IA. Comment puis-je vous aider aujourd'hui?`,
  German: `Hallo! Ich bin Contract Lens, Ihr KI-Assistent. Wie kann ich Ihnen heute helfen?`,
  Italian: `Ciao! Sono Contract Lens, il tuo assistente AI. Come posso aiutarti oggi?`,
  Portuguese: `Olá! Eu sou Contract Lens, seu assistente de IA. Como posso ajudá-lo hoje?`,
  Russian: `Здравствуйте! Я Рово, ваш ИИ-ассистент. Чем я могу вам помочь сегодня?`,
  Japanese: `こんにちは！私はContract Lensです、あなたのAIアシスタントです。今日はどのようにお手伝いできますか？`,
  Korean: `안녕하세요! 저는 Contract Lens입니다, 당신의 AI 어시스턴트입니다. 오늘 어떻게 도와드릴까요?`,
  Chinese: `你好！我是Contract Lens，您的AI助手。今天我能为您做些什么？`,
  Turkish: `Merhaba! Ben Contract Lens, yapay zeka asistanınızım. Bugün size nasıl yardımcı olabilirim?`,
  Dutch: `Hallo! Ik ben Contract Lens, je AI-assistent. Hoe kan ik je vandaag helpen?`,
  Polish: `Cześć! Jestem Contract Lens, twój asystent AI. Jak mogę ci dzisiaj pomóc?`,
  Czech: `Ahoj! Jsem Contract Lens, váš AI asistent. Jak vám dnes mohu pomoci?`,
  Greek: `Γεια σας! Είμαι ο Contract Lens, ο AI βοηθός σας. Πώς μπορώ να σας βοηθήσω σήμερα;`,
  Hungarian: `Helló! Contract Lens vagyok, az AI asszisztensed. Hogyan segíthetek ma?`,
};
